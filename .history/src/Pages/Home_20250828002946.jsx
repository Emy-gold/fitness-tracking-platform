            ...
            <main className='flex flex-col justify-center items-center mx-auto'>
                ...
                <section className='flex flex-col items-start mb-10 gap-5 justify-center mx-72 max-w-full font-lexend'>
                    ...
                    <div className='flex flex-wrap gap-6 lg:w-[1200px]'>
                        <div className='flex justify-between p-5 border rounded-2xl lg:w-[1200px] shadow-sm hover:shadow-md transition duration-300'>
                            <div className='flex flex-col items-start text-left'>
                                ...
                                <button className='bg-buttonColor px-5 py-2 rounded-3xl mt-5 font-medium hover:bg-gray-300 hover:scale-105 duration-300'>Learn more</button>
                            </div>
                            <img src={img1} className='lg:w-[400px]' />
                        </div>
                        <div className='flex justify-between p-5 border rounded-2xl lg:w-[1200px] shadow-sm hover:shadow-md transition'>
                            <div className='flex flex-col items-start text-left'>
                                ...
                                <button className='bg-buttonColor px-5 py-2 rounded-3xl mt-5 font-medium hover:bg-gray-300 hover:scale-105 duration-300'>View Progress</button>
                            </div>
                            <img src={img2} className='lg:w-[400px]' />
                        </div>
                        <div className='flex justify-between p-5 border rounded-2xl lg:w-[1200px]'>
                            <div className='flex flex-col items-start text-left'>
                                ...
                                <button className='bg-buttonColor px-5 py-2 rounded-3xl mt-5 font-medium hover:bg-gray-300 hover:scale-105 duration-300'>Explore Exercises</button>
                            </div>
