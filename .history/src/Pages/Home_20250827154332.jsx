        ...
        <>
            <main className='flex flex-col justify-center items-center mx-auto'>
                ...
                <section className='my-10 relative flex justify-center'>
                    <img src={homepic} className="md:w-[800px] lg:w-[1300px]" />
                ...
                <section className='flex flex-col items-start md-10 mb:w-[900px] lg:w-[1300px]'>
                    ...
                    <div className='flex flex-row gap-4 mt-10 text-left md:w-[900px] lg:w-[1400px]'> {/* Removed justify-center */}
                        {cards.map(card => (
                            <div key={card.id} className='md:w-[312px] lg:w-[425px] bg-white rounded-xl shadow-md p-3 hover:scale-105 duration-300'>
                ...
                <section className='flex flex-col items-start mb-10 gap-5 justify-center mx-72 max-w-full mt-6'>
                    <h2 className='text-3xl font-bold mb-4'>Benefits</h2>
                    <div className='flex flex-wrap gap-6 lg:w-[1300px]'>
                        <div className='flex justify-between p-5 border lg:w-[1400px]'>
                            <div className='flex flex-col items-start text-left'>
                                <h3 className='text-2xl font-bold mb-4'>Personalized Workout Plans</h3>
                                <p className='text-xl text-slate-300-300'>Tailored workout plans designed to meet your specific fitness goals and experience level.</p>
                                <button>Learn more</button>
                            </div>
                            <img src={img1} className='lg:w-[500px]' />
                        </div>
