        ...
        <>
            <main className='flex flex-col justify-center items-center mx-auto'>
                <section className='my-10 relative flex justify-center'>
                    <img src={homepic} className="mb:w-[980px] max-w" />
                ...
                <section className='flex flex-col items-start mb-10 mb:w-[980px] max-w'>
                    ...
                    <div className='flex flex-row gap-4 mt-10 text-left mb:w-[980px] max-w'> {/* Removed justify-center */}
                        {cards.map(card => (
                ...
                <section className='flex flex-col items-start mb-10 gap-5 justify-center mx-72 max-w-full font-lexend'>
                    ...
                    <div className='flex flex-wrap gap-6 max-w'>
                        {benefits.map(benefit => (
                            <div key={benefit.id} className='flex flex-row-reverse justify-between p-5 border rounded-2xl max-w '>
