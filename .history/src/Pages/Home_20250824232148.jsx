    ...
    return (
        <>
            <main className='flex flex-col justify-center px-40'>
                ...
                <section className='flex flex-col items-start px-12'>
                    ...
                    <div className='flex flex-wrap gap-8 mt-10 text-left h-40'> {/* Removed justify-center */}
                        {cards.map(card => (
                            <div key={card.id} className='w-72 h-40 bg-white rounded-xl shadow-md p-2'>
