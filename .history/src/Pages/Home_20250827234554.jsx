            ...
            <main className='flex flex-col justify-center items-center mx-auto'>
                ...
                <section className='flex flex-col items-start mb-10 gap-5 justify-center mx-72 max-w-full font-lexend'>
                    ...
                    <div className='flex flex-wrap gap-6 lg:w-[1200px]'>
                        <div className='flex justify-between p-3 border lg:w-[1200px]'>
                            <div className='flex flex-col items-start text-left'>
                        ...
                        <div className='flex justify-between  border lg:w-[1200px]'>
                            <div className='flex flex-col items-start text-left'>
                                <h3 className='text-2xl font-bold mb-4 text-textColor'>Extensive Exercise Library</h3>
                                <p className='text-lg text-paragraphColor font-medium'>Access a vast library of exercises with detailed instructions and video demonstrations.</p>
