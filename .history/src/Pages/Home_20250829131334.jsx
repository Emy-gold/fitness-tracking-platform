                ...
                <section className='flex flex-col items-start mb-10 gap-5 justify-center max-w-7xl mx-auto px-4'>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        {benefits.map(benefit => (
                            <div key={benefit.id} className='flex flex-row-reverse justify-between p-5 border rounded-2xl w-full lg:w-full hover:opacity-30 duration-300 hover:scale-105'>
