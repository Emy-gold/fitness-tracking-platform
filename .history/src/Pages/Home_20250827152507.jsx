        ...
        <>
            <main className='flex flex-col justify-center items-center mx-auto'>
                ...
                <section className='my-10 relative flex justify-center'>
                    <img src={homepic} className="mb:w-[970px] lg:w-[1200px]" />
                ...
                <section className='flex flex-col items-start mb-10 mb:w-[970px] lg:w-[1200px]'>
                    ...
                    <div className='flex flex-row gap-4 mt-10 text-left mb:w-[900px] lg:w-[1200px]'> {/* Removed justify-center */}
                        {cards.map(card => (
