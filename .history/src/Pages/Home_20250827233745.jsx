                    ...
                    <div className='flex flex-wrap gap-6 lg:w-[1200px]'>
                        ...
                        <div className='flex justify-between p-5 border lg:w-[1200px]'>
                            <div className='flex flex-col items-start text-left mr-5'>
                                <h3 className='text-2xl font-bold mb-4 text-slate-900'>Progress Tracking & Analytics</h3>
                                <p className='text-md text-gray-600 font-medium'>Monitor your progress with detailed analytics and visualizations to stay motivated.</p>
                        ...
                        <div className='flex justify-between p-5 border lg:w-[1200px]'>
                            <div className='flex flex-col items-start text-left mr-5'>
                                <h3 className='text-2xl font-bold mb-4 text-slate-900'>Extensive Exercise Library</h3>
                                <p>Access a vast library of exercises with detailed instructions and video demonstrations.</p>
