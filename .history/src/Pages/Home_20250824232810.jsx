...
function Home() {
    ...
    return (
        <>
            <main className='flex flex-col justify-center items-center w-1000'>
                ...
                <section className='flex flex-col items-start w-full'>
                    ...
                    <div className='flex flex-row gap-4 mt-10 text-left w-full'> {/* Removed justify-center */}
                        {cards.map(card => (
                            <div key={card.id} className='w-72 bg-white rounded-xl shadow-md p-2'>
