    ...
    return (
        <>
            <main className='flex flex-col justify-center items-center'>
                ...
                <section className='flex flex-col items-start mb-10 mb:w-[980px] lg:w-[1300px]'>
                ...
                <section className='flex flex-col items-start mb-10 mb:w-[980px] lg:w-[1200px] gap-5'>
                    <h2>Benefits</h2>
