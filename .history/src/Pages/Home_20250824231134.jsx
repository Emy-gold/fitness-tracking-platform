    ...
    return (
        <>
            <main className='flex flex-col justify-center px-40'>
                ...
                <section className='my-8 relative flex flex-col justify-center px-10'>
                    <div>
                        <h2>Key Features</h2>
                        <p>Explore the powerful features of FitTrack designed to help you stay motivated and reach your fitness aspirations.</p>
                    </div>
