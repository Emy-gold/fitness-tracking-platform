        ...
        <>
            <main className='flex flex-col justify-center items-center mx-auto'>
                ...
                <section className='flex flex-col items-start md-10 mb:w-[900px] lg:w-[1300px]'>
                    ...
                    <div className='flex flex-row gap-4 mt-10 text-left md:w-[900px] lg:w-[1200px]'> {/* Removed justify-center */}
                        {cards.map(card => (
                            <div key={card.id} className='md:w-[312px] lg:w-[450px] bg-white rounded-xl shadow-md p-2 hover:scale-105 duration-300'>
