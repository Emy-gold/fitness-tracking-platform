...
function Home() {
    ...
    return (
        <>
            <main className='flex flex-col justify-center items-center mx-auto lg:w-[1400px}'>
                ...
                <section className='flex flex-col items-start mb-10 mb:w-[980px] lg:w-[1400px] gap-5 justify-center'>
                    <h2>Benefits</h2>
                    <div className='flex flex-wrap gap-5'>
                        <div className='flex justify-center p-4 border mb:w-[980px] lg:w-[1200px]'>
